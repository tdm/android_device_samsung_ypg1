...
## kernel modules
#PRODUCT_COPY_FILES += \
#    $(call find-copy-subdir-files,*,device/samsung/ypg1/modules,system/lib/modules)
...
PRODUCT_COPY_FILES += \
    device/samsung/ypg1/kernel-ypg1_usa-cm7.bin:kernel-XAA \
    device/samsung/ypg1/kernel-ypg1_intl-cm7.bin:kernel \
    device/samsung/ypg1/recovery.bin:recovery.bin

# Install scripts
PRODUCT_COPY_FILES += \
    device/samsung/ypg1/fsconvert.sh:fsconvert.sh \
    device/samsung/ypg1/updatekernel.sh:updatekernel.sh \
    device/samsung/ypg1/copyefsdata.sh:copyefsdata.sh
